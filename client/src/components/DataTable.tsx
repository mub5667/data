          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                ...
                className="pl-10 pr-4 py-2 bg-white border-slate-200 focus:border-blue-500 transition-colors"
              />
            </div>
              ...
              <Table>
                <TableHeader className="bg-slate-50">
                  <TableRow className="border-b border-slate-200 hover:bg-slate-50">
                    {columns.map((col) => (
                      <TableHead 
                        key={col.key} 
                        className="font-semibold text-slate-700 whitespace-nowrap py-4 cursor-pointer hover:bg-slate-100 transition-colors"
                        onClick={() => handleSort(col.key)}
                      >
                ...
                <TableBody>
                  {sortedData.map((row) => (
                    <TableRow 
                      key={row.id} 
                      className="border-b border-slate-100 last:border-0 hover:bg-blue-50/50 transition-colors group"
                    >
                      {columns.map((col) => (
                        <TableCell key={col.key} className="py-3">
                          {editingId === row.id ? (
                            <Input
                              ...
                              className="h-8 text-sm border-slate-300 focus:border-blue-500"
                            />
                          ) : (
